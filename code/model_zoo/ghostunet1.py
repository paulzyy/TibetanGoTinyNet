...
from .modules import ResidualConv, Upsample,GhostBottleneckV2,GhostBottleneck

@zutils.register_model
class Ghostunet1(torch.jit.ScriptModule):
    __constants__ = [
        "c_prime",
        "h_prime",
        "w_prime",
    ...
    def __init__(self, game_params: GameParams, model_params: ModelParams):
        ...
        self.up_residual_conv1 = GhostBottleneck(filters[3] + filters[2], filters[2], filters[2],1, se_ratio=0.)
