...
class Ghostunet2SECapCA(torch.jit.ScriptModule):
    __constants__ = [
        "c_prime",
        "h_prime",
        "w_prime",
    ...
    def __init__(self, game_params: GameParams, model_params: ModelParams):
        ...
        self.residual_conv_1 = GhostBottleneck(72,72,72,se_ratio=1)
        # self.residual_conv_1 = GhostModuleVV(72, 72, relu=True, mode='attn')
        self.residual_conv_2 = GhostBottleneck(72, 72, 72, se_ratio=1)
        # self.residual_conv_2 = GhostModuleVV(72, 72, relu=True, mode='attn')
        self.residual_conv_3 = GhostBottleneck(72, 72, 72, se_ratio=1)
        self.bridge = GhostBottleneck(72, 72, 72, se_ratio=1)
        ...
        self.encoder_output_atoms = [8, 8, 16, 9, 16, 24]
